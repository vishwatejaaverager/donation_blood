...
class UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(name: $name, age: $age, gender: $gender, bloodGroup: $bloodGroup, medIssues: $medIssues, location: $location, profileImage: $profileImage, lat: $lat, long: $long, phone: $phone, isAvailable: $isAvailable, userId: $userId)';
  }
